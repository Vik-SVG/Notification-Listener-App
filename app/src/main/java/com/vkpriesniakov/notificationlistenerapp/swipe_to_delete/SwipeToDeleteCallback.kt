package com.vkpriesniakov.notificationlistenerapp.swipe_to_delete
...
open class SwipeToDeleteCallback(context:Context):ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT) {
    ...
    private val backgroundColor = Color.parseColor("#940A00")
    ...
    override fun onMove(
        ...
        return false //implementing moving items
    }
